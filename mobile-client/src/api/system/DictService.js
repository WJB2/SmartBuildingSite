...
async function addDictEntry(params){
    return request('/api/system/dict/entry',{
        method:'POST',
        body:params,
    });
}
...
async function editDictEntry(params){
    return request(`/api/system/dict/entry/${params.id}`,{
        method:'PUT',
        body:params,
    });
}
...
async function findDictEntryList(params){
    return request(`/api/system/dict/entry/list?${params}`,{
        method:'GET',
    });
}

async function findDictEntryPage(params){
    return request(`/api/system/dict/entry/page?${params}`,{
        method:'GET',
    });
}
